...
const DiscoveryCard: React.FC<DiscoveryCardProps> = ({ image, lastDirection, onSwipe }) => {
  ...
  const isDragging = useTransform(dragX, [-0.1, 0, 0.1], [1, 0, 1]);
  ...
  return (
    <motion.div
      ...
      className="absolute w-[calc(100%-3rem)] h-[42vh] md:w-[400px] md:h-[400px] md:max-h-[55vh] flex items-center justify-center [touch-action:pan-x] cursor-grab active:cursor-grabbing z-10 shadow-[0_12px_35px_rgba(0,0,0,0.08)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.14)] transition-all duration-500"
    >
      ...
      <div className="flex-1 relative px-6 overflow-visible grid place-items-center">
        ...
        {currentIndex + 1 < sessionStack.length && (
          <div className="absolute w-[calc(100%-3rem)] h-[42vh] md:w-[400px] md:h-[400px] md:max-h-[55vh] flex items-center justify-center pointer-events-none">
            <div className="w-full h-full bg-[#ede8df] overflow-hidden opacity-40 scale-[0.96]">
